  ...
  return (
    <SpaceBetween size="l">
      ...
      >
        <SpaceBetween size="m">
          ...
          <Alert type="info">
            ...
            <ul>
              <li>Amazon Bedrock (for Claude Sonnet)</li>
      ...
      >
        <SpaceBetween size="m">
          <Alert type="info">
            <Box variant="h4">Federal Wage Compliance</Box>
            <Box>
              The system automatically validates timecards against federal wage laws:
            </Box>
            <ul>
              <li>Federal minimum wage: $7.25/hour</li>
              <li>Overtime threshold: 40 hours/week</li>
              <li>Salary exempt threshold: $684/week</li>
              <li>Maximum recommended hours: 60/week</li>
            </ul>
          </Alert>
      ...
      >
        <ColumnLayout columns={2}>
          ...
          <Box>
            <Box variant="h4">Application</Box>
            <ul>
              <li>Version: {systemInfo.version || '1.0.0'}</li>
              <li>Environment: {systemInfo.environment || 'Development'}</li>
            </ul>
          </Box>
        </ColumnLayout>
      </Container>
